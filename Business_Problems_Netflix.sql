...
10. Find each year and the average (%) share of content released by India
    on Netflix. Return the top 5 years with the highest share.
...
15. Categorize the content based on the presence of the keywords 'kill'
    and 'violence' in the description field. Label content containing
